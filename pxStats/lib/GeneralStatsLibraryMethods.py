...
class GeneralStatsLibraryMethods:
    ...
    def getRxTxNamesHavingRunDuringPeriod( start, end, machines, pattern = None, havingrunOnAllMachines = False  ):  
        ...
        for rxDatabase in rxOnlyDatabases:  
            ...
            #print rxDatabase, StatsDateLib.getIsoFromEpoch(lastUpdate), StatsDateLib.getIsoFromEpoch(start)
            if lastUpdate >= start:
                #print rxDatabase, StatsDateLib.getIsoFromEpoch(lastUpdate), StatsDateLib.getIsoFromEpoch(start)
        ...
        for txDatabase in txOnlyDatabases:                
            ...
            #print txDatabase, StatsDateLib.getIsoFromEpoch(lastUpdate), StatsDateLib.getIsoFromEpoch(start)
            if lastUpdate >= start:
