...
def main():
    ...
    #status, output = commands.getstatusoutput( "scp /apps/px/stats/graphs/symlinks/* pds@lvs2-op:/apps/pds/tools/Columbo/ColumboShow/graphs/ >>/dev/null 2>&1" )
    #print output
    
    #status, output = commands.getstatusoutput( "scp /apps/px/stats/graphs/symlinks/* pds@lvs1-op:/apps/pds/tools/Columbo/ColumboShow/graphs/ >>/dev/null 2>&1" )
    #print output
